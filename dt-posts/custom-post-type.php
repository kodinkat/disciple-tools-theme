...
class Disciple_Tools_Post_Type_Template {
    ...
    public function dt_set_roles_and_permissions( $expected_roles ){
        ...
        //@todo check of post type is custom
        if ( isset( $custom_post_types[ $this->post_type ] ) ){
            if ( isset( $expected_roles['administrator'] ) ){
                $expected_roles['administrator']['permissions']['access_' . $this->post_type] = true;
                $expected_roles['administrator']['permissions']['view_any_' . $this->post_type] = true;
                $expected_roles['administrator']['permissions']['update_any' . $this->post_type] = true;
                $expected_roles['administrator']['permissions']['dt_all_admin_' . $this->post_type] = true;
                $expected_roles['administrator']['permissions']['delete_any' . $this->post_type] = true;
            }
        }
    }
